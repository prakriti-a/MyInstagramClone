...
public class SplashScreen extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!splashLoaded) {
            ...
            }, secondsDelayed * 3000); // perform the run() tasks after secondsDelayed in milliseconds
            // here, one second
            splashLoaded = true;
        }
        else { // when Splash is loaded
            Intent goToMainActivity = new Intent(SplashScreen.this, SignUpActivity.class);
